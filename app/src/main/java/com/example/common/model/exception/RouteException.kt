...
sealed class RouteException(message: String?) : Exception(message) {
    sealed class Network(message: String? = null) : RouteException(message) {
    ...
    sealed class Client(message: String? = null) : RouteException(message) {
    ...
    sealed class Server(message: String? = null) : RouteException(message) {
    ...
    sealed class Local(message: String? = null) : RouteException(message) {
    ...
    data class Unknown(override val message: String?) : RouteException(message)
